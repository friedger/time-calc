...
import { StyledTimeList } from './TimeList';
import 'jest-enzyme';
...
describe('Component - TimeList', () => {
  ...
  it('renders time rows', () => {
    const component = shallowWithStore(
      <StyledTimeList times={times} load={jest.fn()} download={jest.fn()} />
    );
  ...
  it('renders an empty div if there are no times to display', () => {
    const component = shallow(
      <StyledTimeList times={[]} clear={clear} download={download} load={load} />
    );
  ...
  it('displays a sum field of all times', () => {
    const component = shallow(
      <StyledTimeList times={times} clear={clear} download={download} load={load} />
    );
  ...
  describe('Actions', () => {
    ...
    it('has a download button which exports the timelist as CSV', () => {
      ...
      component
        .find('button')
        .filterWhere(n => n.text() === 'cloud_download')
        .first()
        .simulate('click');
